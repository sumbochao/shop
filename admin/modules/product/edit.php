...
<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" id="inputEmail3" placeholder="Bitis Hunter" name="name" value="<?php echo $Editproduct['name'] ?>">
        </div>
...
<?php  endif  ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="number" class="form-control" id="inputEmail3" placeholder="599.000" name="price"  value="<?php echo $Editproduct['price'] ?>">
...
<?php  endif  ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="number" class="form-control" id="inputEmail3" placeholder="900" name="number"  value="<?php echo $Editproduct['number'] ?>">
